  ...
  db.roles.insertMany([
    {
      ...
      isActive: true,
      rights: {
        POST: { own: true, any: false, role: false, invitation: false },
        PUT: { own: true, any: false, role: false, invitation: false },
        PATCH: { own: true, any: false, role: false, invitation: false },
        DELETE: { own: true, any: false, role: false, invitation: false },
        GET: { own: true, any: false, role: false, invitation: false },
      },
    ...
    },
    {
      ...
      isActive: true,
      rights: {
        POST: { own: true, any: true, role: true, invitation: true },
        PUT: { own: true, any: true, role: true, invitation: false },
        PATCH: { own: true, any: true, role: true, invitation: false },
        DELETE: { own: true, any: true, role: true, invitation: false },
        GET: { own: true, any: true, role: true, invitation: true },
      },
      createdAt: new Date(),
      updatedAt: new Date()
    },
    {
      ...
      rights: {
        POST: { own: true, any: true, role: true, invitation: true },
        PUT: { own: true, any: true, role: true, invitation: true },
        PATCH: { own: true, any: true, role: true, invitation: true },
        DELETE: { own: true, any: true, role: true, invitation: true },
        GET: { own: true, any: true, role: true, invitation: true },
      },
      createdAt: new Date(),
      updatedAt: new Date()
